...
<template>
    <div class="mt-60">
        ...
        <div class="flex items-center justify-center w-full h-full px-2 py-9 bg-[#FFF] rounded-3xl border-2 border-t-[#E4B764] ">
            <div  
            ...
            <div
                ...
                class="relative shrink-0 w-[350px] rounded-xl overflow-hidden border border-yellow-400 bg-black shadow-lg"
            >
                ...
                <div class="w-220 h-60 overflow-hidden ">
                    ...
                    >
                        ...
                        />
                        <!-- Match Info -->
                        <div class="flex w-[350px] h-13 pl-5 pr-1 bg-gradient-to-b from-[#F8E889] to-[#E4B764] rounded-xl">
                            <div class="w-full">
                                <div class="flex mb-1 items-center justify-center pt-1 pr-9">
                                <p class="text-sm text-[#b3b3b3]">{{ item.home }} <span class=" font-semibold text-[10px] text-black">VS </span>{{ item.away }}</p> 
                                </div>
                                <div class="text-sm font-bold text-black flex items-center justify-center pr-9">
                                    {{ item.commentator }}
                                </div>
                            </div>
                            <!-- Status Button -->
                            <div class=" flex items-center ml-auto">
                                ...
                                class=""
                                >
                                <img width="55" :src="item.statusiCon" alt="notifi">
                                </div>
                                <div
                                v-else
                                class=""
